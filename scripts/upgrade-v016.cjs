...
const oneGarage = '  { id: "garage-door-16", group: "Doors", label: "Double Garage Door 16\\\'", shortLabel: "Garage 16\\\'", type: "door", style: "garage", widthFt: 16, heightFt: 7, icon: "garage-door" },';
...
if (!app.includes('garage-door-9')) {
  if (!app.includes(oneGarage)) throw new Error('v0.16 garage catalog target missing');
  app = app.replace(oneGarage, garageSet);
}
