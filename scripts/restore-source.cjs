...
try {
  ...
  require('./upgrade-v021.cjs');
  require('./upgrade-v022.cjs');
  require('./upgrade-v023.cjs');
  require('./upgrade-v024.cjs');
  require('./upgrade-v025.cjs');
  require('./upgrade-v026.cjs');
  require('./upgrade-v027.cjs');
  require('./upgrade-v028.cjs');
  require('./upgrade-v029.cjs');
